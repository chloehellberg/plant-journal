...
export class Plant {
  ...
  waterDate(inputDate) {
    ...
    if (this.type == "Succulent") {
      ...
      this.waterNote =
        "You will need to water your plant about every 10 days. In addition, if the leaves feel rubbery and bend easily at any point, please water your succulent. If the leaves change color, you are over watering your succulent.";
    } else if (this.type == "Cactus") {
      daysTilWatering += 14;
      this.waterDay = daysTilWatering - inputDate;
      this.waterNote =
        "You will need to water your plant about every 14 days. Let cacti dry completely between waterings.";
    } else if (this.type == "Flower") {
      daysTilWatering += 7;
      this.waterDay = daysTilWatering - inputDate;
      this.waterNote =
        "Many indoor flowers (except orchids) will need to be watered every 7 days.";
    } else {
      daysTilWatering += 4;
      this.waterDay = daysTilWatering - inputDate;
      this.waterNote =
        "You will need to water your plant about every 4 days. Ferns like to be misted, and moist but not waterlogged.";
    }
    if (this.waterDay > 0) {
